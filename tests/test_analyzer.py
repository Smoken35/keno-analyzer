...
class TestKenoAnalyzer:
    ...
    def test_calculate_expected_value(self, test_analyzer):
        ...
        payout_table = {5: {0: 0, 1: 1, 2: 5, 3: 20, 4: 100, 5: 500}}
        ...
        with pytest.raises(ValueError, match="No payout table for pick size 6"):
            test_analyzer.calculate_expected_value(pick_size=6)
