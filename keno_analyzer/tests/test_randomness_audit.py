...
class TestKenoRandomnessAudit(unittest.TestCase):
    ...
    def _create_test_database(self):
        ...
        cursor.executemany("INSERT INTO games (numbers, draw_date) VALUES (?, ?)", test_data)
    ...
    def _create_test_report(self):
        ...
        report = {
            ...
            "autocorrelation": {"score": 0.88, "acf_values": np.random.rand(80, 10).tolist()},
            "overall_score": 0.895,
        }
    ...
    def test_load_draw_data(self):
        ...
        numbers, dates = auditor.load_draw_data(start_date="2024-01-01", end_date="2024-01-02")
