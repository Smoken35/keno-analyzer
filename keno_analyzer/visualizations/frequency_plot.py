...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("frequency_plot.log"), logging.StreamHandler()],
)
...
class KenoVisualizer:
    ...
    def generate_visualizations(self, output_dir: str):
        ...
        self.plot_number_frequencies(output_dir / "number_frequencies.png")

        # Generate temporal heatmap
        self.plot_temporal_heatmap(output_dir / "temporal_heatmap.png")
