...
class PatternMiner:
        ...
        for item, nodes in tree['header'].items():
            ...
            if support >= self.min_support * self.transaction_count:
                ...
                if cond_tree['root']:
                    ...
                    patterns.extend(
                        self._mine_fp_tree(cond_tree, new_pattern)
                    )
    ...
    def mine_patterns(self, numbers: List[List[int]], algorithm: str = 'fp-growth') -> List[FrequentSet]:
        """
        ...
        while current_sets:
            ...
            for itemset, count in set_counts.items():
                ...
                if support >= self.min_support:
                    frequent_k_sets.append(FrequentSet(
