...
class AssociationEngine:
    ...
    def _calculate_rule_metrics(self, 
                              antecedent: Set[int], 
                              consequent: Set[int],
        ...
        expected_support = (antecedent_count / self.transaction_count) * (consequent_count / self.transaction_count)
        lift = support / expected_support if expected_support > 0 else 0
        
        return support, confidence, lift
    
    def _generate_rules(self, 
                       frequent_set: Set[int], 
                       transactions: List[Set[int]]) -> List[AssociationRule]:
        """
