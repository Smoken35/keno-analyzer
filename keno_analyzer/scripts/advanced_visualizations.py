...
def plot_time_series(results: Dict[str, Dict[str, Any]], output_dir: str, window_size: int = 50) -> str:
...
def generate_all_visualizations(results: Dict[str, Dict[str, Any]], output_dir: str) -> Dict[str, str]:
