...
def evaluate_all_strategies(data: List[List[int]], start_index: int = 50, end_index: int = None) -> Dict[str, Dict[str, Any]]:
    ...
    for strategy_name in tqdm(strategy_names, desc="Evaluating strategies"):
        ...
        result = engine.evaluate_strategy(strategy_name, data, start_index=start_index, end_index=end_index)
...
def main():
    ...
    all_plot_paths = {
        'basic_comparison': basic_plot_path,
        **advanced_plot_paths
    }
