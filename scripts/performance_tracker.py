...
class PerformanceTracker:
    ...
    def analyze_performance(self, days: int = 100) -> Dict:
        ...
        try:
            ...
            performance = {
                ...
                'recent_performance': self._calculate_recent_performance(recent_results, best_pick_size)
            }
    ...
    def plot_performance(self, save_dir: str):
        ...
        max_streaks = [self.performance_history[-1]['consecutive_payouts'][m]['max_streak'] for m in methods]
