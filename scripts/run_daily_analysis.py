...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("daily_analysis_scheduler.log"), logging.StreamHandler()],
)
...
def run_analysis():
    ...
    try:
        ...
        if performance:
            ...
            logger.info(
                f"Recent Performance: Win Rate: {recent['win_percentage']:.2f}%, ROI: {recent['roi']:.2f}%"
            )
