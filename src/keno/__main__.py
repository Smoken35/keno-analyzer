...
def main(args: Optional[List[str]] = None) -> int:
    ...
    predict_parser.add_argument(
        ...
        type=int,
        default=4,
        help='Number of picks to predict'
    )
    predict_parser.add_argument(
        '--source',
        default='sample',
        help='Data source (sample or URL)'
    )
    predict_parser.add_argument(
        '--days',
        type=int,
    ...
    visualize_parser.add_argument(
        ...
        type=int,
        default=30,
        help='Number of days of data to visualize'
    )
    ...
    validate_parser.add_argument(
        ...
        type=int,
        default=4,
        help='Number of picks to validate'
    )
    validate_parser.add_argument(
        '--draws',
        type=int,
        default=100,
        help='Number of draws to validate against'
    )
    validate_parser.add_argument(
        '--source',
        default='sample',
